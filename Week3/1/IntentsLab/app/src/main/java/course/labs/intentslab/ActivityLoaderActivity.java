...
public class ActivityLoaderActivity extends Activity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ActivityLoaderActivity.GET_TEXT_REQUEST_CODE && resultCode == Activity.RESULT_OK) {
            CharSequence  userEnteredText = data.getCharSequenceExtra(ExplicitlyLoadedActivity.USER_ENTERED_TEXT);
