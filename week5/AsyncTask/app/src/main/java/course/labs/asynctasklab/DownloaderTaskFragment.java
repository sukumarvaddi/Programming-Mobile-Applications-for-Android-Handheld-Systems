...
public class DownloaderTaskFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Integer> friends = argumentsBundle.getIntegerArrayList(MainActivity.TAG_FRIEND_RES_IDS);

        //Start the DownloaderTask
        new DownloaderTask().execute(friends);
    ...
    public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Void, String[]> {
        ...
        @Override
        protected String[] doInBackground(ArrayList<Integer>... text_files) {
            ArrayList<Integer> feeds = text_files[0];
            Integer[] resourceIds = Arrays.copyOf(feeds.toArray(), feeds.toArray().length, Integer[].class);
            feeds.toArray();
